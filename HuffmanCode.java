...
public class HuffmanCode {
	...
	public static void main(String[] args) throws IOException {
      ...
      //  String test = "banana"; // Tamanho do texto = 64 bits 
		String nome;
        ...
        // Compactar o texto
        String encode = encode(tree,linha);
       ...
       double taxa_compressao =  ((double)linha.length() * 3 /encode.length());
       
       System.out.println("Taxa de Compressão:" + taxa_compressao);     
